...
- [x] 1014-02-PLAN.md — Widget threshold-test DELETE batch (TestStatusWidget, TestGaugeWidget, TestIconCardWidget, TestMultiStatusWidget, TestChipBarWidget) — 35 methods deleted
- [x] 1014-03-PLAN.md — *Tag.m Threshold-call strip (TestIconCardWidgetTag, TestMultiStatusWidgetTag, TestSensorDetailPlotTag, TestEventDetectorTag, TestLiveEventPipelineTag, TestFastSenseAddTag, TestMonitorTagPersistence)
