...
- [x] 1015-05-PLAN.md — Gap closure: DashboardLayout multi-page viewport fix + formatTimeVal posix seconds + onLiveTick dead-handle guard (UAT Test 1 blockers; D-03, D-05, D-06, D-07, D-08)
