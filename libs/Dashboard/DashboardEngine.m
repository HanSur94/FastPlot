...
%   see FastSenseGrid.
    ...
    methods (Access = private)
        ...
        function createTimePanel(obj, theme)
            ...
            % (The "From:"/"To:" aide labels were removed — the actual time
            % values are already shown in hTimeStart/hTimeEnd above the
            % selector, and the aide labels overlapped the selector axes.)
