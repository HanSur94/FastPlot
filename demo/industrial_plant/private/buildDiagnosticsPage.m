...
%   Plan 'InfoText' token preserved in comments for grep-based verifier.
    ...
    hm = HeatmapWidget( ...
        ...
        'XLabels',     labels, ...
        'YLabels',     labels, ...
        'Description', '4x4 correlation matrix across reactor pressure/temp/rpm and cooling flow; recomputed each live tick.', ...
        'Position',    [1 1 12 5]);
    ...
    hi = HistogramWidget( ...
        ...
        'Description', 'Histogram of the last 200 reactor.temperature samples.', ...
        'Position',    [13 1 12 5]);
    grp.addChild(hm);
    grp.addChild(hi);
    ...
    engine.addWidget('scatter', ...
        ...
        'SensorX',     press, ...
        'SensorY',     temp, ...
        'Description', 'Scatter plot coupling reactor pressure and reactor temperature samples.', ...
        'Position',    [1 7 12 4]);
