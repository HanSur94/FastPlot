...
% Row 9-16: File-based image — writes a temp PNG then loads via File property
tmpFile = [tempname '.png'];
imwrite(thermalImg, tmpFile);
d.addWidget('image', 'Title', 'File-Based Image', ...
    'Position', [1 9 12 8], ...
    'File', tmpFile, ...
    'Caption', ['Loaded from ' tmpFile], ...
    'Scaling', 'fill');
