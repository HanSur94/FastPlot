...
yVib = 1.5 + 0.8*sin(2*pi*t/7200) + randn(1,N)*0.15;
% Transient anomaly window: inject +1.2 RMS between t=43200 and t=46800
vibWindow = t > 43200 & t < 46800;
yVib(vibWindow) = yVib(vibWindow) + 1.2;
